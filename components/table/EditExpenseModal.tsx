...
import { Expense, ExpenseUpdatePayload } from "@/types";
...
export default function EditExpenseModal({ expense, onClose }: Props) {
  ...
  const [form, setForm] = useState<ExpenseUpdatePayload>({
  ...
  const labelClass = "text-[9px] text-[#c0bbb4] font-mono block mb-1 tracking-widest uppercase";
  const selectClass =
